<script lang="ts">
	/**
	 * `/operacoes/presenca` — a tela do POLICIAL na GISE: onde ele confirma entrada e saída
...
>
	<!-- Voltar ACIMA do título, como nas demais telas de detalhe: para o Admin
	     ...
	     botão "Formulário" de /operacoes/gise/operacoes — e desde que o item saiu da barra
	     lateral, o caminho de volta precisa estar na própria página. -->
	{#if isAdminGeral}
		<BotaoVoltar href="/operacoes/gise/operacoes" rotulo="Voltar às operações" />
	{/if}
