...
- [ ] Retorno antecipado (unidade e DPI SUL): num afastamento em curso (não férias) da linha do tempo, o botão "Retorno antecipado" abre data do retorno (limitada ao período) e NUP; registrado, o evento passa a terminar na véspera, a descrição ganha "Retorno antecipado em … (NUP …)" e o outro lado recebe a notícia; retorno fora do período → 409
