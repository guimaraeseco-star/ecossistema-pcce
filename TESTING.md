...
- [ ] Retorno antecipado (unidade e DPI SUL): no quadro "Solicitações deste servidor", o pedido de afastamento APROVADO e em curso (não férias) mostra o botão "Retorno antecipado", que abre data do retorno (limitada ao período) e NUP; registrado, o afastamento da linha do tempo passa a terminar na véspera, a descrição ganha "Retorno antecipado em … (NUP …)" e o outro lado recebe a notícia; retorno fora do período → 409; a linha do tempo NÃO tem esse botão (só Corrigir/Excluir do Admin Geral)
