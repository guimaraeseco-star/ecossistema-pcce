...
| Campo               | Valor                                                                                                                                                                                                                                                                                                           |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Versão do documento | 1.3 — 12/09/2026                                                                                                                                                                                                                                                                                                |
...
| Selo institucional (`SELO_INSTITUCIONAL_PEM`) — nome a confirmar; segredos dos workflows de backup e LGPD; PRs do Dependabot #1–#6; DMARC `p=none` → endurecer | Erlon + eu | assinatura avançada; backup automático           |
