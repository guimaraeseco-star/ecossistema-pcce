...
| Campo               | Valor                                                                                                                                                                                                                                                                                                           |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Versão do documento | 1.2 — 12/09/2026                                                                                                                                                                                                                                                                                                |
...
| Domínio                   | **`dpisul.com.br`** — Registro.br, titular guimaraes.eco@gmail.com, pago por 2 anos, **vence 12/09/2028** (E38). Zona criada na Cloudflare (NS `abdullah.ns.cloudflare.com` e `aria.ns.cloudflare.com`); será `APP_ORIGIN` e domínio de e-mail | PLANEJADO — delegação no Registro.br pendente; hoje o app responde em https://escalas-13i.pages.dev          |
...
| Migrações                           | Numeradas, sequenciais, à mão, nunca editadas depois de mesclada. Última: `0084` (árvore da corporação, PR 1.5). Próximas: `0085`–`0088` (Ecossistema), `0089+` (diárias). Ver §7                                                                                                                                                                                   | EXISTE / PLANEJADO |
...
| Produção | Pages `escalas`, branch `main` → https://escalas-13i.pages.dev (futuro: https://dpisul.com.br)                                              | `escalas-db` (`a544616e-1f0f-4438-b88c-24e807c1c680`)                                                                         | `escalas-docs`         | merge em `main`                            |
...
| ---- | ------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| 0    | Infra na conta própria; primeiro deploy do sistema como está — **FEITA em 12/09/2026** (falta só domínio → e-mail → 2FA do bootstrap) | —                                   |
...
| Delegar `dpisul.com.br` aos NS da Cloudflare no Registro.br (janela de transição de ~1 h após o registro); depois custom domain, e-mail, `APP_ORIGIN`, 2FA do bootstrap | Erlon + fase 0 | e-mail e 2FA                                     |
